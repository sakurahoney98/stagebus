...
public class Tela_Linha_Geral extends javax.swing.JFrame {
	
	private LinhaController lineController = new LinhaController();
	private static UsuarioModel userModel;
	private static LinhaModel line = new LinhaModel();
	
	public static LinhaModel getLine() {
    ...
    public Tela_Linha_Geral() {
        ...
        ImageIcon icon = new ImageIcon("src/main/resources/Images/titulo_linha.png");
	...
	private void initComponents() {
        ...
        // Dados da tabela
        Object[][] dados = lineController.generateLineList(lineController.listOfLine());

        // Nomes das colunas
        String[] colunas = {"Número da Linha", "Nome"};
        ...
        jTableLinhas.setFont(new java.awt.Font("Calibri", 1, 18));
        jTableLinhas.setForeground(new Color(68, 114, 196));
        jTableLinhas.setRowHeight(30);
        jTableLinhas.getColumnModel().getColumn(0).setPreferredWidth(300);
    	jTableLinhas.getColumnModel().getColumn(1).setPreferredWidth(600);
        ...
        JTableHeader header = jTableLinhas.getTableHeader();
    ...
    private void jTextFieldBuscarKeyReleased(java.awt.event.KeyEvent evt) {                                          
    	  ...
    	  Object[][] dados = lineController.generateLineList(lineController.search(jTextFieldBuscar.getText()));
    	    DefaultTableModel model = (DefaultTableModel) jTableLinhas.getModel();
    	    model.setDataVector(dados, new String[]{"Número da Linha", "Nome"});
    }
    ...
    private void jTableLinhasMouseClicked(java.awt.event.MouseEvent evt) {
    	
    	Object value = jTableLinhas.getValueAt(jTableLinhas.getSelectedRow(), 0);
        line = lineController.searchByLineNumber(value.toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Linha_Geral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
