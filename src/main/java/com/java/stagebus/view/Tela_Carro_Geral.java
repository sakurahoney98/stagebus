...
public class Tela_Carro_Geral extends javax.swing.JFrame {
	...
	public static CarroModel getCar() {
    ...
    public Tela_Carro_Geral() {
        ...
        ImageIcon icon = new ImageIcon("src/main/resources/Images/titulo_carro.png");
	...
	private void initComponents() {
        ...
        // Dados da tabela
        Object[][] dados = carController.generateCarList(carController.listOfCar());

        // Nomes das colunas
        String[] colunas = {"Número", "Nome", "Garagem"};
       ...
       if(userModel.isCad_car()){
        ...
        jTableCarros.setFont(new java.awt.Font("Calibri", 1, 18));
        jTableCarros.setForeground(new Color(68, 114, 196));
        jTableCarros.setRowHeight(30);
        jTableCarros.getColumnModel().getColumn(0).setPreferredWidth(100);
    	jTableCarros.getColumnModel().getColumn(1).setPreferredWidth(600);
    	jTableCarros.getColumnModel().getColumn(2).setPreferredWidth(400);
        ...
        JTableHeader header = jTableCarros.getTableHeader();
    ...
    private void jTextFieldBuscarKeyReleased(java.awt.event.KeyEvent evt) {                                          
    	  ...
    	  Object[][] dados = carController.generateCarList(carController.search(jTextFieldBuscar.getText()));
    	    DefaultTableModel model = (DefaultTableModel) jTableCarros.getModel();
    	    model.setDataVector(dados, new String[]{"Número", "Nome", "Garagem"});
    }
    ...
    private void jTableFuncionariosMouseClicked(java.awt.event.MouseEvent evt) {
    	...
    	Object value = jTableCarros.getValueAt(jTableCarros.getSelectedRow(), 0);
    	int id = Integer.parseInt(value.toString());
        car = carController.searchByID(id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Carro_Geral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
